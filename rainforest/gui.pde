...
public void shippingOptionsButtonClicked(GButton source, GEvent event) { //_CODE_:shippingOptionsButton:842274:
  println("shippingOptionsButton - GButton >> GEvent." + event + " @ " + millis());
...
public void shippingOptionsChange(GDropList source, GEvent event) { //_CODE_:shippingOptions:918514:
  println("shippingOptions - GDropList >> GEvent." + event + " @ " + millis());
} //_CODE_:shippingOptions:918514:
...
public void createGUI(){
  ...
  shippingOptionsButton = new GButton(this, 662, 556, 80, 30);
  ...
  shippingOptions = new GDropList(this, 52, 227, 180, 90, 2, 20);
  shippingOptions.setItems(loadStrings("list_918514"), 0);
  shippingOptions.addEventHandler(this, "shippingOptionsChange");
}
